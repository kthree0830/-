...
-(void)prepareLayout{
    ...
    for (int i = 0; i < self.numberOfItems; i++) {
        ...
        // x
        CGFloat detalX = self.sectionInsets.left + (self.wf_itemSize.width + self.insertItemSpacing) * shortIndex;
        ...
        la.frame = CGRectMake(detalX, detalY, self.wf_itemSize.width, itemHeight);
